...
class Player extends ObjectData
{
	...
	public $data = array('id' => null, 'name' => null, 'group_id' => 1, 'account_id' => null, 'level' => 1, 'vocation' => 0, 'health' => 1, 'healthmax' => 1, 'experience' => 0, 'lookbody' => 0, 'lookfeet' => 0, 'lookhead' => 0, 'looklegs' => 0, 'looktype' => 128, 'lookaddons' => 0, 'maglevel' => 0, 'mana' => 0, 'manamax' => 0, 'manaspent' => 0, 'soul' => 0, 'town_id' => 0, 'posx' => 0, 'posy' => 0, 'posz' => 0, 'conditions' => null, 'cap' => 0, 'sex' => 0, 'lastlogin' => 0, 'lastip' => 0, 'save' => 1, 'skull' => 0, 'skulltime' => 0, 'lastlogout' => 0, 'blessings' => 0, 'onlinetime'  => 0, 'deletion' => 0, 'balance' => 0, 'stamina' => 0, 'skill_fist' => 10, 'skill_fist_tries' => 0, 'skill_club' => 10, 'skill_club_tries' => 0, 'skill_sword' => 10, 'skill_sword_tries' => 0, 'skill_axe' => 10, 'skill_axe_tries' => 0, 'skill_dist' => 10, 'skill_dist_tries' => 0, 'skill_shielding' => 10, 'skill_shielding_tries' => 0, 'skill_fishing' => 10, 'skill_fishing_tries' => 0 , 'deleted' => 0, 'description' => '', 'comment' => '', 'create_ip' => 0, 'create_date' => 0, 'hide_char' => 0);
	public static $fields = array('id', 'name', 'group_id', 'account_id', 'level', 'vocation', 'health', 'healthmax', 'experience', 'lookbody', 'lookfeet', 'lookhead', 'looklegs', 'looktype', 'maglevel', 'mana', 'manamax', 'manaspent', 'soul', 'town_id', 'posx', 'posy', 'posz', 'conditions', 'cap', 'sex', 'lastlogin', 'lastip', 'save', 'skull', 'skulltime', 'lastlogout', 'blessings', 'onlinetime', 'deletion', 'balance', 'skill_fist', 'skill_fist_tries', 'skill_club', 'skill_club_tries', 'skill_sword', 'skill_sword_tries', 'skill_axe', 'skill_axe_tries', 'skill_dist', 'skill_dist_tries', 'skill_shielding', 'skill_shielding_tries', 'skill_fishing', 'skill_fishing_tries', 'deleted', 'description', 'comment', 'create_ip', 'create_date', 'hide_char');
